    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFF3C8C3C)),
          useMaterial3: true,
        ),
...
class _AuthWrapperState extends State<AuthWrapper> {
  late final Future<void> _authStatusFuture;

  @override
  void initState() {
    super.initState();
    _authStatusFuture = context.read<AuthProvider>().checkAuthStatus();
  }
